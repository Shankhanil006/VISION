...
view1_live_frame_dir      = path + '/vip_vol2/live_vqa/live_vqa_frames_diff_gray/reference/'
view1_epfl_cif_frame_dir  = path + '/vip_vol2/epfl_vqeg_video/epfl_cif_frames_diff_gray/reference/'
view1_epfl_4cif_frame_dir = path + '/vip_vol2/epfl_vqeg_video/epfl_4cif_frames_diff_gray/reference/'
view1_mobile_frame_dir    = path + '/vip_vol2/live_mobile/live_mobile_frames_diff_gray/reference/'
view1_csiq_frame_dir      = path + '/vip_vol2/CSIQ/csiq_frames_diff_gray/reference/'
view1_ecvq_frame_dir      = path + '/vip_vol2/ECVQ/ecvq_frames_diff_gray/reference/'
view1_evvq_frame_dir      = path + '/vip_vol2/EVVQ/evvq_frames_diff_gray/reference/'
...
class Models(object):
    ...
    def get_model(self):
        ...
        view2_input_shape = (None, None, None, 2)
...
model.compile(Adam(1e-4), loss_fn)
loss = []    
...
#            crop = np.concatenate([crop_view1, crop_view2], axis = 0)
    ...
    #    for ref in ref_id:
            ...
            ref_view1 = curr_crop.astype('int16') - next_crop.astype('int16')
...
#            ref_view2 = curr_crop.astype('int16') - next_crop.astype('int16')#optical_flow.calc(curr_crop, next_crop, None)
    ...
    #            next_crop = pyramid(next_crop, scale, res)
                ...
                dist_view1 = curr_crop.astype('int16') - next_crop.astype('int16')
...
#        base_model.compile(optimizer=model.optimizer, loss = loss_fn)
        view1_model.save(output_directory + 'tmp/contrastive_models/test/' +'FDvsOF_diff_contrastive_' + str(0) + 'x_'+  str(epoch) + '.h5')
        view2_model.save(output_directory + 'tmp/contrastive_models/test/' +'FDvsOF_flow_contrastive_' + str(0) + 'x_'+  str(epoch) + '.h5') #
