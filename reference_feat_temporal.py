...
output_dir = '/media/ece/DATA/Shankhanil/VQA/contrastive_features/ablation/augmentation/'

loss_fn = contrastive_Loss_func(0)
#base_model= get_model()
#model = multi_gpu_model(base_model, gpus=2)

model_0x = load_model('/media/ece/DATA/Shankhanil/VQA/tmp/contrastive_models/ablation/inter_authentic_FvsFD_diff_contrastive_0x_5000.h5', custom_objects={'loss': loss_fn})
#model_0x = load_model('/media/ece/DATA/Shankhanil/VQA/tmp/contrastive_models/acm/authentic/authentic_temporal_contrastive_0x_5000.h5')
...
#    for ref_id in range(databases[train_db]['ref']):
    ...
    for name in filenames:
            ...
            for j in range(0, len(get_video)-1, 2):
                    ...
                    framediff_0x, sigma = flow_based_patch_generator(frame_diff, frame11, 0.85).patch_generator()
...
savemat(output_dir + 'inter_authentic_FvsFD_diff_ref_feat_0x_5000.mat',mdic)
#savemat(output_dir + 'authentic_temporal_ref_feat_0x_5000_0.95.mat',mdic)
