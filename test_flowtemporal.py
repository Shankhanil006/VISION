...
syn_feat_spa = loadmat('/media/ece/DATA/Shankhanil/VQA/contrastive_features/ablation/cmc/cmc_FvsOF_frame_ref_feat_0x_3000.mat')['feat'].squeeze()
#syn_feat_spa = loadmat('/media/ece/DATA/Shankhanil/VQA/contrastive_features/acm/authentic/authentic_flow_ref_feat_0x_5000.mat')['feat'].squeeze()

syn_feat_tmp = loadmat('/media/ece/DATA/Shankhanil/VQA/contrastive_features/ablation/cmc/cmc_FvsOF_flow_ref_feat_0x_3000.mat')['feat'].squeeze()
#syn_feat_tmp = loadmat('/media/ece/DATA/Shankhanil/VQA/contrastive_features/acm/authentic/authentic_temporal_ref_feat_0x_5000.mat')['feat'].squeeze()
...
#
model_0x_spa = load_model('/media/ece/DATA/Shankhanil/VQA/tmp/contrastive_models/ablation/FvsOF_frame_cmc_0x_3000.h5')
model_0x_tmp = load_model('/media/ece/DATA/Shankhanil/VQA/tmp/contrastive_models/ablation/FvsOF_flow_cmc_0x_3000.h5')

#model_0x_spa = load_model('/media/ece/DATA/Shankhanil/VQA/tmp/contrastive_models/acm/authentic/authentic_flow_contrastive_0x_5000.h5')
#model_0x_tmp = load_model('/media/ece/DATA/Shankhanil/VQA/tmp/contrastive_models/acm/authentic/authentic_temporal_contrastive_0x_5000.h5')
...
for i in range(len(vid_id)): #  vid_names# epfl_video_list #  video_list  #  flickr_id
#    break
    video_feat_frame = []
...
#    frame_rate = live_video_list[0].split('_')[-1][:2]
...
#    frame_rate =25
    ...
    for j in range(0, len(get_video)-1, frame_rate):
        ...
        framediff_0x, framediff_1x, framediff_2x, framediff_3x = extract_patches(flow)
...
output_dir = '/home/ece/Shankhanil/VQA/ablation/cmc/'
#np.save(output_dir + 'utube_flowspatial_cmc.npy', x1)

#np.save(output_dir + 'utube_flowtemporal.npy', (x1+x2)/2)
